...
class NewEventForm(ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'time': forms.TimeInput(attrs={'class': 'event_time_input', 'id': 'new_event_time'}),
...
class EditEventForm(ModelForm):
    class Meta:
        ...
        fields = ['title', 'date', 'time', 'description']
        widgets = {
            'title': forms.fields.TextInput(attrs={'class': 'event_title_input', 'id': 'edit_event_title'}),
            'time': forms.TimeInput(attrs={'class': 'event_time_input'}),
            'date': forms.DateInput(attrs={'class': 'event_date_input', 'id': 'edit_event_date'}),
            'description': forms.Textarea(attrs={'class': 'event_description_input', 'id': 'edit_event_description'})
            }